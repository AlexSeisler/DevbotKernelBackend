...
class FederationService():
    ...
    def link_federation_node(payload: LinkFederationNodeRequest):
        from services.db.semantic_manager import SemanticManager
        try:
            if payload.name.strip() == "*":
                ...
                self.graph_manager.auto_link_all_nodes(
            ...
            logical_repo_id = self.repo_manager.resolve_repo_id_by_pk(payload.repo_id)
